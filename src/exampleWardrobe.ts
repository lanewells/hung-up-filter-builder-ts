...
export const exampleWardrobe: WardrobeItem[] = [
  ...
  {
    id: "4",
    name: "Orange drawstring Bermuda shorts",
    brand: "Paloma Wool",
    drawer: "Bottoms",
    color: "orange",
    price_usd: 110,
  ...
  {
    id: "7",
    name: "Black spandex bike shorts",
